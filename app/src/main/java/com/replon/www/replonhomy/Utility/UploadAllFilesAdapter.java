...
public class UploadAllFilesAdapter extends RecyclerView.Adapter<UploadAllFilesAdapter.UploadsViewHolder>{
    ...
    public UploadAllFilesAdapter(Context mContext, List<UploadsAttachmentContent> uploadsList, ArrayList<Uri> imageURIlist, ArrayList<String>file_type) {
       ...
       //holder.images.setImageDrawable(mContext.getResources().getDrawable(uploadsAttachmentContent.getImage(),null));
        ...
        holder.images.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                showAddDeleteDialog(i,imageURIlist,file_type);
                return true;
            }
        });
    ...
    public void showAddDeleteDialog(final int pos,final ArrayList<Uri>imageURIlist,final ArrayList<String>file_type){
